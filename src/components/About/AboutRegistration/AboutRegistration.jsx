...
const AboutRegistration = () => {
  useEffect(() => {
    ...
    mm.add('(min-width: 727px)', () => {
      RegistrationTwo.to('.about-reg-left', {
    ...
    <div className="about-reg-container">
      ...
      <div className="about-reg-wrapper">
        <div className="about-reg-left">
          ...
          <p>
            Whether you're a bike owner or a client, joining the Zummey
            community is simple and hassle-free. Download our mobile application
            or access our user-friendly web app to get started.
          </p>
          <Link to="/location" className="get_notified get_notified_about">
            <button>
